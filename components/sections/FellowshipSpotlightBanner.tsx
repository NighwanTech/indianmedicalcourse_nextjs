  ...
  const programs = [
    {
      ...
      enrolled: "1,150+ Doctors Enrolled",
      lessons: "68 Clinical Modules",
      duration: "12 Months (Hybrid)",
      rating: "4.9 / 5.0",
      badge: "Interventional Cardiology",
      certificate: "CPD & Cath Lab Certificate Included",
      highlights: [
        ...
        "Hospital Rotations | CPD UK Accredited",
      ],
    },
    {
      id: 2,
      title: "Fellowship in Aesthetic Dermatology & Cosmetic Surgery",
      ...
      enrolled: "1,290+ Doctors Enrolled",
      lessons: "62 Practical Modules",
      duration: "12 Months (Hybrid)",
      rating: "5.0 / 5.0",
      badge: "Aesthetic Medicine",
      certificate: "Clinical Hands-on Injectable Certification",
      highlights: [
    ...
    },
    {
      ...
      enrolled: "950+ Surgeons Enrolled",
      lessons: "56 Surgical Modules",
      duration: "12 Months (Hospital Attachment)",
      rating: "4.9 / 5.0",
      badge: "Minimal Access Surgery",
      certificate: "Robotic Simulation & Live OT Certified",
      highlights: [
    ...
    },
    {
      ...
      enrolled: "1,210+ Gynaecologists Enrolled",
      lessons: "54 Diagnostic Modules",
      duration: "12 Months (Hybrid)",
      rating: "5.0 / 5.0",
      badge: "Perinatology & Radiology",
      certificate: "FMF-Aligned Clinical Scan Reporting Certified",
      highlights: [
